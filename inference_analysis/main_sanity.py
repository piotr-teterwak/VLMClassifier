            ...
            if classes.index(data[idx]["label"]) == 150 or classes.index(data[idx]["label"]) == 151:
                 if "blip" in model_id:
                     ...
                     probs = process_image(
                         ...
                         data[idx]["image"],
                         classes[150:152],
                         "USER: <image>\n What type of vehicle is in this photo? Is it a  a.) 2012 Lamborghini Aventador Coupe or b.) 2012 Lamborghini Gallardo LP 570-4 Superleggera?\nASSISTANT: The photo features a car, specifically a",
                     )
