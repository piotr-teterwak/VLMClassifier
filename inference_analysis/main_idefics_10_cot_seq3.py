...
def main(model_id, data_path, class_path, split, seed, output_path):
    ...
    classes_1 = all_classes[0:5] + ['None of the above']
    classes_2 = all_classes[5:10] + ['None of the above']
    #data = data[:1000]
        ...
        for idx in trange(len(data)):
             if all_classes.index(data[idx]["label"]) in range(10):
                 ...
                 if "blip" in model_id:
                     ...
                     choices_1 = '\n'.join(['{} {}'.format(c_idx,c) for c_idx,c in  zip(['A.', 'B.', 'C.', 'D.', 'E.', 'F.'],classes_1)])
                     choices_2 = '\n'.join(['{} {}'.format(c_idx,c) for c_idx,c in  zip(['A.', 'B.', 'C.', 'D.', 'E.', 'F.'],classes_2)])
