...
def main(model_id, data_path, class_path, split, seed, output_path):
    ...
    with open(output_path, "a") as f:
        for idx in trange(len(data)):
             if classes.index(data[idx]["label"]) == 150 or classes.index(data[idx]["label"]) == 151:
                 ...
                 if "blip" in model_id:
                     ...
                     prompt = "User:<image>Answer the multiple choice question. What is the year, make, and model of  the vehicle in this photo? Is it  a.) 2012 Lamborghini Aventador Coupe or b.) 2012 Lamborghini Gallardo LP 570-4 Superleggera?<end_of_utterance>\nAssistant: The year, make, and model of the vehicle in this photo is "
                 ...
                 data[idx]["label_index"] = classes.index(data[idx]["label"]) - 150
